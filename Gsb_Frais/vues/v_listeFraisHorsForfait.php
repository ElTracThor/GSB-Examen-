...
<table class="listeLegere">
  	   <caption>Descriptif des éléments hors forfait
             ...
             <tr>
                ...
                <th class="libelleMode">Mode de paiement</th>  
                <th class="action">&nbsp;</th>              
             </tr>
    ...
    <?php    
      ...
      $paiement= $unFraisHorsForfait['libelleMode'];
	?>		
            <tr>
                <td><?php echo $date ?></td>
